    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="p-4 border-t border-gray-100 space-y-2">
          <div className="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-xl p-3 shadow-md">
            <h3 className="text-white font-bold text-xs mb-1 flex items-center gap-1.5 leading-none">
              ✨ Besoin d'aide ?
            </h3>
            <p className="text-purple-100 text-[10px] mb-2 leading-tight">
              Un expert peut t'aider à avancer plus vite.
            </p>
            <Link
              to={createPageUrl('Booking')}
              className="flex items-center justify-center gap-1.5 w-full bg-white hover:bg-gray-50 text-gray-900 font-bold py-1.5 px-3 rounded-lg transition-all"
            >
              <Calendar className="w-3.5 h-3.5" />
              <span className="text-[11px]">Prendre rendez-vous</span>
            </Link>
          </div>

          <div className="bg-gradient-to-br from-amber-400 to-yellow-500 rounded-xl p-3 shadow-md">
            <h3 className="text-white font-bold text-xs mb-1 flex items-center gap-1.5 leading-none">
              ✨ Communauté
            </h3>
            <p className="text-amber-50 text-[10px] mb-2 leading-tight">
              Reçois du soutien de la part des membres.
            </p>
            <a
            ...
            >
              ...
              <span className="text-[11px]">Accéder à Skool</span>
            </a>
          </div>
