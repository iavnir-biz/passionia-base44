...
export default function LandingFooterV2({ onCTA }) {
      ...
      <section ref={ref} className="landing-fade" style={{
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{
            ...
            Arrête de réfléchir. Lance-toi. Deviens{' '}
            <span style={{
              fontStyle: 'italic',
              fontWeight: 500,
          ...
          <p style={{
            ...
            Rejoins +500 créateurs qui ont lancé leur activité grâce à NOAH™.
            Dans 15 minutes, tu sais quoi vendre, à qui, et comment.
          </p>

          {/* CTA bar */}
          <div className="footer-cta-bar-v2" style={{
            display: 'inline-flex',
            alignItems: 'center',
            ...
            <span className="footer-cta-price-v2" style={{
              padding: '0 22px',
            ...
            >
              Créer mes offres — 29€ <ArrowRight size={16} />
            </button>
          </div>
