  ...
  return (
    <div className="flex min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="flex-1 ml-0 lg:ml-72 w-full">
        ...
        <main className="p-4 lg:p-8 w-full max-w-3xl mx-auto">
          {loading ? (
            ...
            <div className="space-y-6">
              {settingsSections.map((section, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 lg:p-6"
                >
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#61f7a2]/10 flex items-center justify-center flex-shrink-0">
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-2xl bg-gray-50 text-gray-600 hover:bg-gray-100/80 hover:text-red-600 transition-all border border-gray-100 font-medium"
                >
