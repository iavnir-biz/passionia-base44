    ...
    >
      ...
      >
        ...
        <motion.path 
          ...
          strokeLinecap="round"
          fill="none"
          animate={isThinking ? { opacity: [0.9, 1, 0.9] } : {}}
        ...
        {/* Pupils - animated */}
        <motion.circle 
          cx="25" cy="27" r="2" fill="#1f2937"
          animate={isThinking ? { cx: [25, 23, 25, 26, 25], cy: [27, 28, 27, 28, 27] } : {}}
          transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.circle 
          cx="41" cy="27" r="2" fill="#1f2937"
          animate={isThinking ? { cx: [41, 39, 41, 42, 41], cy: [27, 28, 27, 28, 27] } : {}}
          transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
        />
        ...
        {/* Thinking sparkles */}
        <motion.circle 
          cx="54" cy="10" r="3" fill="white"
          animate={isThinking ? { opacity: [0.4, 1, 0.4], scale: [0.8, 1.2, 0.8] } : { opacity: 0.7 }}
          transition={{ duration: 1.2, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.circle 
          cx="10" cy="12" r="2" fill="#fbbf24"
          animate={isThinking ? { opacity: [0.5, 1, 0.5], scale: [0.9, 1.1, 0.9] } : { opacity: 0.6 }}
          transition={{ duration: 1, repeat: Infinity, ease: "easeInOut", delay: 0.3 }}
        />
        <motion.circle 
          cx="52" cy="52" r="2" fill="#fbbf24"
          animate={isThinking ? { opacity: [0.3, 0.8, 0.3] } : { opacity: 0.5 }}
