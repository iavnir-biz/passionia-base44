      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-4">
            À partir de maintenant, je vais <span className="text-gray-900 font-semibold">personnaliser ton parcours</span> et créer tes offres, pour t'aider à savoir <span className="text-gray-900 font-semibold">quoi vendre, à qui et à combien</span>.
          </p>
          <p className="text-gray-900 font-semibold text-[15px]">
            Voici ce que je vais faire pour toi :
          </p>
        </motion.div>
