      ...
      {items.map((item) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="object-cover object-top rounded-full h-10 w-10 border-2 border-white group-hover:scale-105 group-hover:z-30 relative transition duration-500"
          />
        </div>
      ))}
    </div>
